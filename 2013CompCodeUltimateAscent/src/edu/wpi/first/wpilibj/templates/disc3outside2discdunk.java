 ...
 * @author Crevolution
 */
public class disc3outside2discdunk extends Command {
    
    boolean finished = false;
    int move1 = Robomap.odmove1;
    int move2 = Robomap.odmove2;
    int move3 = Robomap.odmove3;
    int move4 = Robomap.odmove4;
    int move5 = Robomap.odmove5;
    
    public disc3outside2discdunk() {
